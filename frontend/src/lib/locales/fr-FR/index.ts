export const frFR = {
  ...
  podcasts: {
    ...
    total: "Total",
    progressPending: "En file d'attente…",
    progressOutline: "Préparation du plan…",
    progressTranscript: "Rédaction du transcript…",
    progressSynthesizing: "Synthèse vocale {done}/{total}…",
    progressCombining: "Assemblage de l'audio…",
    ...
    publishNeedsAudio: "Générez l'audio avant de publier cet épisode.",
    episodePublished: "Épisode publié",
    episodePublishedDesc: "L'épisode est désormais disponible dans son flux de podcast.",
    failedToPublish: "Échec de la publication de l'épisode",
    episodeUnpublished: "Épisode dépublié",
    episodeUnpublishedDesc: "L'épisode a été retiré de son flux de podcast.",
    failedToUnpublish: "Échec de la dépublication de l'épisode",
    distributionTab: "Diffusion",
    distributionTitle: "Diffusion",
    distributionDesc: "Exposez vos séries sous forme de flux RSS et soumettez-les aux annuaires de podcasts.",
    feedReady: "Prête à soumettre",
    feedIncomplete: "Incomplète",
    publishedEpisodeCount: "{count} épisodes publiés",
    copyFeedUrl: "Copier l'URL du flux",
    openFeed: "Ouvrir le flux",
    feedUrlCopied: "URL du flux copiée",
    feedUrlCopiedDesc: "L'URL du flux RSS est maintenant dans votre presse-papier.",
    feedUrlCopyFailed: "Impossible de copier l'URL du flux",
    feedsLoadErrorTitle: "Échec du chargement des flux",
    feedsLoadErrorDesc: "Nous n'avons pas pu récupérer vos flux de podcast. Réessayez dans un instant.",
    loadingFeeds: "Chargement des flux…",
    noFeedsYet: "Aucun flux de podcast pour le moment. Publiez un épisode pour exposer sa série sous forme de flux RSS.",
  },
  settings: {
